...
public class RestaurantController {
    ...
    public ObjectNode getRestaurantById(@RequestBody ObjectNode response) {
        return restaurantService.getRestaurantByRA(response.get("ra").asInt());
    }
    ...
    public ObjectNode deleteRestaurantById(@RequestBody ObjectNode response) {
        return restaurantService.deleteRestaurantById(response.get("ra").asInt());
    }
    ...
    public ObjectNode eated(@RequestBody ObjectNode response) {
        return restaurantService.eated(response.get("ra").asInt());
    }
    ...
    public ObjectNode recharge(@RequestBody ObjectNode response) {
        return restaurantService.recharged(response.get("ra").asInt(), response.get("value").asDouble());
    }
    ...
    public ObjectNode updateRoll(@RequestBody ObjectNode response) {
        return restaurantService.updateRoll(response.get("ra").asInt());
    }
}
